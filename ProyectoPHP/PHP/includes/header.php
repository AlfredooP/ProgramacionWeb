...
<head>
    ...
    <link rel="preload" href="../CSS/styleHeader.css" as="style">
...
<body>
    ...
    <nav class="nav-principal">
        ...
        <a class="boton" href="../PHP/producto.php">Productos</a>
        ...
        <a href="../indices/carrito.html"><svg xmlns="http://www.w3.org/2000/svg" class="icono" width="25" height="25" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffde59" fill="none" stroke-linecap="round" stroke-linejoin="round">
